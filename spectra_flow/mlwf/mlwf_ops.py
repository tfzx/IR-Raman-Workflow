...
class Prepare(OP, abc.ABC):
    ...
    Discription
    -----
    This is a SuperOP to generate inputs from the template and puts them into subpaths. 
    ...
    -`conf_fmt`: `dict`.
        The format of the confs. 
        Example: 
        ```python
        {
            "fmt": "deepmd/raw",    # See the fmt parameters in dpdata.System.
            "type_map": ["O", "H"]
        }
        ```
